 ...
 * @author Alan
 */
public class RgPunctureAction extends RangedAction {

    public RgPunctureAction(Entity actor, int skillId) {
        super(actor, skillId);
    }

    public RgPunctureAction(Entity actor, int skillId, Thing dobj) {
        super(actor, skillId, dobj);
    }

    public RgPunctureAction(Entity actor, int skillId, Thing dobj, Thing iobj) {
